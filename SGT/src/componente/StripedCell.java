...
public class StripedCell implements TableCellRenderer {
	  public StripedCell(TableCellRenderer targetRenderer,
	  ...
	  public static void installInColumn(JTable table, int columnIndex,
	    ...
	    tc.setCellRenderer(new StripedCell(targetRenderer,
	  ...
	  public static void installInTable(JTable table, Color evenBack,
		  ...
		  StripedCell sharedInstance = null;
	    ...
	    for (int i = 0; i < columns; i++) {
	      ...
	      if (targetRenderer != null) {
	        ...
	        if (sharedInstance == null) {
	          sharedInstance = new StripedCell(null,
	              evenBack, evenFore, oddBack, oddFore);
	        }
